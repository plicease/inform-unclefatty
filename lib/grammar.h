...
#ifdef PROVIDE_SHOW_SCOPE;
Verb 'show' 'present' 'display'
	* creature scope=ShowScope		-> Show reverse
	* scope=ShowScope 'to' creature		-> Show;
#endif;
#ifndef PROVIDE_SHOW_SCOPE;
Verb 'show' 'present' 'display'
